...
$result_id="";
		...
		{	
			...
			$result_password=$db->get_staff_password_from_mobile_no($staff_login);
			...
			if($flag==0)
			{
				...
				{	
					$db->change_staff_password($new_pass,$staff_login);
					?>
					<script>
			...
			<div class="row">
				...
				<div class="col-sm-4 col-md-4 col-lg-4 form-group mb-4">
					...
					<div class="input-group-icon input-group-icon-left  set-row">
						...
						<input type="password" id="password" class="form-control form-control-air"  placeholder="Enter Current Password"  value="<?php echo $password; ?>" name="password" >
					</div>
				...
				<div class="col-sm-4 col-md-4 col-lg-4 form-group mb-4">
					...
					<div class="input-group-icon input-group-icon-left  set-row">
						<span class="input-icon input-icon-left"><i class="fas fa-lock"></i></span>
						<input type="password" id="new_pass" class="form-control form-control-air"  placeholder="Enter New Password" name="new_pass"  value="<?php echo $new_pass; ?>">
					</div>
				</div>
				<div class="col-sm-4 col-md-4 col-lg-4 form-group mb-4">
					...
					<div class="input-group-icon input-group-icon-left  set-row">
						<span class="input-icon input-icon-left"><i class="fas fa-lock"></i></span>
						<input type="password" name="new_confirm_pass" id="new_confirm_pass" placeholder="Enter Confirm New Password" name="new_pass" class="form-control form-control-air" value="<?php echo $new_confirm_pass; ?>"  />
					</div>
