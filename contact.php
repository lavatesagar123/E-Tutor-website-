                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="contact-us-info2">
                            <ul>
                                <li><i class="fa fa-map-marker" aria-hidden="true"></i>Belati, Solpaur</li>
                                <li><i class="fa fa-phone" aria-hidden="true"></i>+91 11145454</li>
                                <li><i class="fa fa-envelope-o" aria-hidden="true"></i>etutor@gmail.co</li>
                            </ul>
                        </div>
                    </div>
