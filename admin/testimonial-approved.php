...
<div class="ibox-body" style="padding:7px; padding-top:0px;">
	...
	<div class="ibox-head">
		<div class="ibox-title"><i class="fas fa-check" style="margin-right:10px;"></i>Testimonial  Approved Report</div>
	</div>
...
<div class="table-responsive row">
	<table class="table table-bordered table-hover" id="example" style="overflow-x:auto;overflow-y:auto;" cellpadding=0 cellspacing=0>
		...
		<tbody>
		<?php
			$report_details = $db->get_all_approved_testinomials();
		...
		?>
			...
			<td><a href="testimonial-approved.php?delete_id=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><i class="fas fa-trash"style="color:red;margin-left:20px;"></i></a></td>
