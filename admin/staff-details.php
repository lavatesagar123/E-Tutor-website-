...
<label class="form-group mb-4 set-row"><b>To Date</b></label>
 ...
 <?php 
	...
	?>
<div class="ibox" style="border-radius:5px; padding:7px; height:700px;">

<div class="ibox-body" style="padding:7px; padding-top:0px;">
	
	<div class="ibox-head">
		<div class="ibox-title"><i class="fas fa-user-tie" style="margin-right:10px;"></i>Staff Details Report</div>
	</div>
...
<div class="table-responsive row">
	<table class="table table-bordered table-hover" id="example" style="overflow-x:auto;overflow-y:auto;" cellpadding=0 cellspacing=0>
		...
		<tbody>
		<?php
			$report_details = $db->get_all_staff_reg_details($from_date,$to_date);
		...
		?>
			<tr> 
				...
				<td><a href="edit-staff-details.php?up_id=<?php echo $id;?>"> <i class="fas fa-edit"style="color:blue;margin-left:20px;"></i></a></td>
				<td><a href="staff-details.php?delete_id=<?php echo $id;?>" onclick="return confirm('Are you sure For Delete This Record?');"><i class="fas fa-trash"style="color:red;margin-left:20px;"></i></a></td>
