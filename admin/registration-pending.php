...
<?php 
	...
	if(isset($_GET['pending_id']))
	{
		 ...
		 $db->pending_registration($pending_id);
...
<div class="ibox-body" style="padding:7px; padding-top:0px;">
	...
	<div class="ibox-head">
		<div class="ibox-title"><i class="fas fa-user-tie" style="margin-right:10px;"></i>Registration Pending Report</div>
	</div>
...
<div class="table-responsive row">
	<table class="table table-bordered table-hover" id="example" style="overflow-x:auto;overflow-y:auto;" cellpadding=0 cellspacing=0>
		...
		<tbody>
		<?php
			$report_details = $db->get_all_registrations($from_date,$to_date);
		...
		?>
			<tr> 
				...
				?>
				 ...
				 <td><a href="registration-pending.php?pending_id=<?php echo $id; ?>" onclick="return confirm('Are you sure For  Approve This Registration?');"><i class="fas fa-clock"style="color:red;margin-left:20px;"></i></a></td>
				 <td><a href="registration-pending.php?delete_id=<?php echo $id;?>" onclick="return confirm('Are you sure For Delete This Record?');"><i class="fas fa-trash"style="color:red;margin-left:20px;"></i></a></td>
