...
?>
<script type="text/javascript">
	alert("Failed...!!! Already Title Exists");
</script>
<?php 
} 
?>
<div class="ibox col" style="border-radius:5px; padding:7px; margin:auto;">
	...
	<form class="form-pink" method="post" action="<?php echo $_SERVER['PHP_SELF']?>" name="myForm" onsubmit="return validateForm()" autocomplete="off" enctype="multipart/form-data">
		...
		<div class="ibox-head">
			<div class="ibox-title"><i class="fas fa-plus-circle" style="margin-right:10px;"></i>Add Question Papers</div>
		...
		<div class="ibox-body">
			...
			<div class="col-sm-12 form-group mb-12">
				...
				<center><button class="btn btn-pink btn-air mr-2" type="submit" name="add_btn">Submit</button></center>
			</div>
		</div>
	</form>
	</div>
				...
				if(!empty($data))
					{
						...
						foreach($data as $record)
						{
							...
							<tr> 
								...
								<td><a href="edit-question-paper.php?up_id=<?php echo $id;?>"><i class="fas fa-edit"style="color:blue;margin-left:20px;"></a></td>
								<td>
									<a href="question-paper.php?del=<?php echo $id;?>&attach=<?php echo $res_attachment;?>" onclick="return confirm('Are You Sure to Delete this Question Paper?');"><i class="fas fa-trash"style="color:red;margin-left:20px;"></i>
									</a>
								</td>
