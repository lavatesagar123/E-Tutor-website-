<?php 
	...
	if($flag==0)
	{
		...
		$image_name = $db->get_icon_from_slider($edit_id);
		if($image_name!="")
		{
			$db->update_icon_in_slider($edit_id,$actual_image_name);
	...
	{
		 $image_name = $db->get_icon_from_slider($edit_id);
		 $db->delete_icon_from_slider($edit_id);
		 unlink('../slider_images/'.$image_name);
		
		 $SuccessMsg=4;
	}
	$data = array();
	$data	=	$db->get_slider_details_by_id($edit_id);
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="ibox">
                            ...
                            <form class="form-pink" method="post" action="<?php echo $_SERVER['PHP_SELF']?>" name="myForm" onsubmit="return validateForm()" autocomplete="off">
                                ...
                                <div class="ibox-head">
                                    <div class="ibox-title">Update URL Name</div>
                                </div>
                                <div class="ibox-body">
                                    <div class="row">
                                        <div class="form-group mb-4">
											<label class="form-group mb-4"><b>Enter URL</b></label>
											<div class="input-group-icon input-group-icon-left  set-row">
												...
												<input type="text" name="url" class="form-control form-control-air" value="<?php echo $url; ?>" placeholder="Enter url"  />
											</div>
										</div>
										...
										<br />
										<br />
											<button class="btn btn-pink btn-air mr-2" type="submit" name="update">Update URL</button>
										</div>
									</div>
								</div>
                                ...
                                <div class="ibox-body">
                                    <div class="row">
                                        <div class="form-group mb-4">
											...
											?>
											<a href="../slider_images/<?php echo $icon; ?>" target="_blank"><img src="../slider_images/<?php echo $icon; ?>" height="50px" width="50px" title="view"></a><br /><br />
							...
							<center><a href="add-image-slider.php" style="text-decoration:underline;" >Back</a></center>
                        </div>
                 </div>
			</div>
